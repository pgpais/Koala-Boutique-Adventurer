...
{
    /// <summary>
    /// A test class used to demonstrate the MMObservable pattern in the MMObservableTest demo scene
    /// This one disables itself on Awake, and passively listens for changes, even when disabled
    /// </summary>
    public class MMObservableTestObserverAutoSleep : MonoBehaviour
    {
        public MMObservableTestSubject TargetSubject;
